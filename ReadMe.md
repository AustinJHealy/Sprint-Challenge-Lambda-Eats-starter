...
The useRouteMatch hook allows you access to the match data of a Route. It matches the URL just like a Route. You can useRouteMatch instead of rendering a Route.


2. How would you explain form validation to someone who has never programmed before?

I would say that it is a built in system put in place to make sure the information or data recieved from the user is in the correct format and shape that is expected.

3. In 1-2 sentences, define end to end testing.

End to end testing is testing the application as a whole and making sure all components work together the way they were designed to.
